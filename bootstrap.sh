...
OVERRIDE_AGENTGLS_PROVIDER_BYPASS_APPROVALS="${AGENTGLS_PROVIDER_BYPASS_APPROVALS:-}"
...
prepare_config() {
  ...
  AGENTGLS_PROVIDER_BYPASS_APPROVALS="${OVERRIDE_AGENTGLS_PROVIDER_BYPASS_APPROVALS:-${AGENTGLS_PROVIDER_BYPASS_APPROVALS:-1}}"
...
AGENTGLS_PROVIDER_BYPASS_APPROVALS=${AGENTGLS_PROVIDER_BYPASS_APPROVALS}
